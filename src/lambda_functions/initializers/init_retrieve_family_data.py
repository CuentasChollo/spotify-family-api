...
def init_retrieve_family_data(event, context):
    ...
    try:
        ...
        new_task = Task(id=task_id, type='RETRIEVE_FAMILY_DATA', status='INITIATED', created_at=created_at, updated_at=created_at)
        ...
        lambda_client.invoke(
            FunctionName="retrieve-family-data",
